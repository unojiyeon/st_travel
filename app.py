...
# 데이터 로드
try:
    df_country = load_data("p1_airbnb/국가별 관광소비 유형.csv")
    df_consume = load_data("p1_airbnb/중국 관광객 신용카드 관광소비 유형.csv")
    df_visit = load_data("p1_airbnb/중국 관광객 지역별 방문비율.csv")
    df_cons_region = load_data("p1_airbnb/중국 관광객 지역별 신용카드 소비비율_f.csv")
